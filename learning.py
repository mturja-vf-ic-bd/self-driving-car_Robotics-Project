...
def train_net(model, params, weights, path, trainFrames, i):
    ...
    observe = params['observe']  # Number of frames to observe before training.
    epsilon = 1
    ...
    while t < train_frames:
        ...
        # Save the model 
        if t % train_frames == 0:
            f_name = os.getcwd() + '/saved-models_'+ path +'/evaluatedPolicies/'+str(i)+'-'+ filename + '-' + str(t) + '.h5'
...
def IRL_helper(weights, path, trainFrames, i, nn_param, params):
